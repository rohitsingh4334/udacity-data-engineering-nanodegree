...
from airflow.operators import (StageToRedshiftOperator, LoadFactOperator, DataQualityOperator, CreateTableOperator)
from helpers import SqlQueries
from sparkify_dimesions_subdag import load_dimensional_tables_dags
...
load_user_dimension_table = SubDagOperator(
    subdag=load_dimensional_tables_dags(
